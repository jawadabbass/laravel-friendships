...
[![Build Status](https://travis-ci.org/jawadabbass/laravel-friendships.svg?branch=master)](https://travis-ci.org/jawadabbass/laravel-friendships)  [![codecov](https://codecov.io/gh/jawadabbass/laravel-friendships/branch/master/graph/badge.svg)](https://codecov.io/gh/jawadabbass/laravel-friendships)  [![Code Climate](https://codeclimate.com/github/jawadabbass/laravel-friendships/badges/gpa.svg)](https://codeclimate.com/github/jawadabbass/laravel-friendships) [![Test Coverage](https://codeclimate.com/github/jawadabbass/laravel-friendships/badges/coverage.svg)](https://codeclimate.com/github/jawadabbass/laravel-friendships/coverage) [![Total Downloads](https://img.shields.io/packagist/dt/jawadabbass/laravel-friendships.svg?style=flat)](https://packagist.org/packages/jawadabbass/laravel-friendships) [![Version](https://img.shields.io/packagist/v/jawadabbass/laravel-friendships.svg?style=flat)](https://packagist.org/packages/jawadabbass/laravel-friendships) [![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat)](LICENSE)
...
```php
composer require jawadabbass/laravel-friendships
```

Publish config and migrations
```
php artisan vendor:publish --provider="Jawadabbass\Friendships\FriendshipsServiceProvider"
```
...
## Setup a Model
```php
use Jawadabbass\Friendships\Traits\Friendable;
...
## How to use
[Check the Test file to see the package in action](https://github.com/jawadabbass/laravel-friendships/blob/master/tests/FriendshipsTest.php)
...
|Event name            |Fired                            |
|----------------------|---------------------------------|
|Jawadabbass\Friendships\Events\Sent      |When a friend request is sent    |
|Jawadabbass\Friendships\Events\Accepted  |When a friend request is accepted|
|Jawadabbass\Friendships\Events\Denied    |When a friend request is denied  |
|Jawadabbass\Friendships\Events\Blocked   |When a friend is blocked         |
|Jawadabbass\Friendships\Events\Unblocked |When a friend is unblocked       |
|Jawadabbass\Friendships\Events\Cancelled |When a friendship is cancelled   |
